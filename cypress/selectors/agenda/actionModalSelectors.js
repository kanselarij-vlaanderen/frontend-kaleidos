...
export const deleteAgendaSelector = '[data-test-agenda-header-deleteAgenda]';
export const addAnnouncementSelector = '[data-test-agenda-header-announcement]';
export const lockAgendaSelector = '[data-test-agenda-header-lockAgenda]';
export const unlockAgendaSelector = '[data-test-agenda-header-unlockAgenda]';
