...
function setDateInFlatpickr(date) {
  ...
  cy.get('.flatpickr-calendar.open .flatpickr-months > .flatpickr-month > .flatpickr-current-month > .numInputWrapper > input').type(date.year());
  cy.get('.flatpickr-calendar.open .flatpickr-months > .flatpickr-month > .flatpickr-current-month > select').select(date.month().toString());
  cy.get('.flatpickr-calendar.open .flatpickr-days').within(() => {
