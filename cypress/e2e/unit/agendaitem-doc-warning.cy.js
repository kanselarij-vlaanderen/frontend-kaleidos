...
context('Agendaitem document warning tests', () => {
  ...
  const file = {
    folder: 'files', fileName: 'test', newFileName: `VR PV ${agendaDate.format('YYYY')}/1`, fileExtension: 'pdf',
  };
  const newFile = {
    folder: 'files', fileName: 'replace', newFileName: `VR PV ${agendaDate.format('YYYY')}/2`, fileExtension: 'pdf',
  };
