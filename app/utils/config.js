...
export default EmberObject.create({
  ...
  formallyOkOptions: [
    ...
    },
    {
      ...
      classNames: 'vlc-agenda-items__status vl-u-text--error auk-u-text-bold vl-u-display-flex',
    ...
    },
    {
      ...
      classNames: 'vlc-agenda-items__status auk-u-text-bold vl-u-display-flex',
