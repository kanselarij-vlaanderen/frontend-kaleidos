...
export default class CasesCaseSubcasesDocumentsSubcaseDocumentsIndexRoute extends Route {
  @service store;
  ...
  redirect() {
    this.router.transitionTo('cases.case.subcases-documents.subcase-documents.approval');
  }
  ...
  async model(params) {
    this.subcase = this.modelFor('cases.case.subcases-documents.subcase-documents');
    const subcase = this.modelFor('cases.case.subcases-documents.subcase-documents');
