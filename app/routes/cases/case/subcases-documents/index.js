...
export default class CasesCaseSubcasesDocumentsIndexRoute extends Route {
  @service store;
  @service router;
  ...
  redirect(model) {
    if (model && model.length > 0) {
      this.router.transitionTo('cases.case.subcases-documents.subcase-documents', model[0]);
    }
  }
}
