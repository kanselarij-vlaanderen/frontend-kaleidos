...
export default class CasesCaseSubcasesDemoSubcaseDemoIndexRoute extends Route {
  @service store;
  ...
  redirect() {
    this.router.transitionTo('cases.case.subcases-demo.subcase-demo.publication');
  }
