...
export default class CasesCaseSubcasesSubmissionSendSubcaseSubmissionSendIndexRoute extends Route {
  @service store;
  ...
  redirect() {
    this.router.transitionTo('cases.case.subcases-submission-send.subcase-submission-send.approval');
  }
  ...
  async model(params) {
    this.subcase = this.modelFor('cases.case.subcases-submission-send.subcase-submission-send');
    const subcase = this.modelFor('cases.case.subcases-submission-send.subcase-submission-send');
