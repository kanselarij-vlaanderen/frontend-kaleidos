...
export default class CasesCaseSubcasesSubmissionSendIndexRoute extends Route {
  @service store;
  @service router;
  ...
  redirect(model) {
    if (model && model.length > 0) {
      this.router.transitionTo('cases.case.subcases-submission-send.subcase-submission-send', model[0]);
    }
  }
}
