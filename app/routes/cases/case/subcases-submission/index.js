...
export default class CasesCaseSubcasesSubmissionIndexRoute extends Route {
  @service store;
  @service router;
  ...
  redirect(model) {
    if (model && model.length > 0) {
      this.router.transitionTo('cases.case.subcases-submission.subcase-submission', model[0]);
    }
  }
}
