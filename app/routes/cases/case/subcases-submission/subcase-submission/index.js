...
export default class CasesCaseSubcasesSubmissionSubcaseSubmissionIndexRoute extends Route {
  @service store;
  ...
  redirect() {
    this.router.transitionTo('cases.case.subcases-submission.subcase-submission.approval');
  }
  ...
  async model(params) {
    this.subcase = this.modelFor('cases.case.subcases-submission.subcase-submission');
    const subcase = this.modelFor('cases.case.subcases-submission.subcase-submission');
