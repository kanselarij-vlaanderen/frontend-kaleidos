...
export default class CasesCaseSubcasesSubmissionEditIndexRoute extends Route {
  @service store;
  @service router;
  ...
  redirect(model) {
    if (model && model.length > 0) {
      this.router.transitionTo('cases.case.subcases-submission-edit.subcase-submission-edit', model[0]);
    }
  }
}
