...
export default class CasesCaseSubcasesSubmissionEditSubcaseSubmissionEditIndexRoute extends Route {
  @service store;
  ...
  redirect() {
    this.router.transitionTo('cases.case.subcases-submission-edit.subcase-submission-edit.approval');
  }
  ...
  async model(params) {
    this.subcase = this.modelFor('cases.case.subcases-submission-edit.subcase-submission-edit');
    const subcase = this.modelFor('cases.case.subcases-submission-edit.subcase-submission-edit');
