...
export default class PublicationsSearchRoute extends Route {
  @service store;
  @service plausible;
  ...
  static postProcessData = (searchData) => {
    PublicationsSearchRoute.postProcessHighlight(searchData);
    PublicationsSearchRoute.postProcessDates(searchData);
    PublicationsSearchRoute.setSubcaseHighlights(searchData);
  ...
  static createFilter(params) {
    const textSearchFields = [...PublicationsSearchRoute.textSearchFields];
  ...
  async model(filterParams) {
    ...
    const filter = PublicationsSearchRoute.createFilter(params);
    ...
    const results = await search(
      ...
      sort,
      filter,
      PublicationsSearchRoute.postProcessData,
      {
        fields: PublicationsSearchRoute.highlightFields,
      }
    );
