...
export default class SubmissionActivity extends Model {
  ...
  @hasMany('piece', { inverse: 'submissionActivities', async: true, polymorphic: true }) pieces; // This relation is serialized, even though it's on the hasMany side, because the belongsTo side isn't exposed by the backend
