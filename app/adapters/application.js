...
export default DS.JSONAPIAdapter.extend({
	...
	checkIfNotificationShouldBeShown(type) {
		const modelListToNotShowNotificationFor = ['subcase-phase-codes', 'genders', 'formally-oks', 'confidentialities', 'approvals', 'alert-types', 'policy-levels', 'subcase-phases', 'meetings', 'postponeds'];
