...
import tableColumns from 'frontend-kaleidos/config/publications/overview-table-columns-proofread';
...
export default class PublicationsIndexController extends Controller {
  ...
  @tracked tableColumnDisplayOptions = JSON.parse(localStorage.getItem('tableColumnDisplayOptionsProofread'))
  ...
  closeFilterTableModal() {
    localStorage.setItem('tableColumnDisplayOptionsProofread', JSON.stringify(this.tableColumnDisplayOptions));
