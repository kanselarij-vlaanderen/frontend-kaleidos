...
import tableColumns from 'frontend-kaleidos/config/publications/overview-table-columns-proof';
...
export default class PublicationsIndexController extends Controller {
  ...
  @tracked tableColumnDisplayOptions = JSON.parse(localStorage.getItem('tableColumnDisplayOptionsProof'))
  ...
  closeFilterTableModal() {
    localStorage.setItem('tableColumnDisplayOptionsProof', JSON.stringify(this.tableColumnDisplayOptions));
