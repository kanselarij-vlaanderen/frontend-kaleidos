...
import tableColumns from 'frontend-kaleidos/config/publications/overview-table-columns-urgent';
...
export default class PublicationsIndexController extends Controller {
  ...
  @tracked tableColumnDisplayOptions = JSON.parse(localStorage.getItem('tableColumnDisplayOptionsUrgent'))
  ...
  closeFilterTableModal() {
    localStorage.setItem('tableColumnDisplayOptionsUrgent', JSON.stringify(this.tableColumnDisplayOptions));
