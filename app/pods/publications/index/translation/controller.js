...
import tableColumns from 'frontend-kaleidos/config/publications/overview-table-columns-translation';
...
export default class PublicationsIndexController extends Controller {
  ...
  @tracked tableColumnDisplayOptions = JSON.parse(localStorage.getItem('tableColumnDisplayOptionsTranslation'))
  ...
  closeFilterTableModal() {
    localStorage.setItem('tableColumnDisplayOptionsTranslation', JSON.stringify(this.tableColumnDisplayOptions));
